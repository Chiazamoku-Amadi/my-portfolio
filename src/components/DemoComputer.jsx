...
const DemoComputer = (props) => {
  const group = useRef();
  const { nodes, materials } = useGLTF("/models/demo_computer.glb");
  ...
  // To flip the video on the screen to the down-side-up every time the texture (video) changes
  // By default, it is up-side-down
  useEffect(() => {
    if (texture) {
      texture.flipY = false;
    }
...
useGLTF.preload("/models/demo_computer.glb");
